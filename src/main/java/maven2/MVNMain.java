...
public class MVNMain {
	...
	public static void createTable() throws Exception {
		...
		try {
			...
			String sql = ("CREATE TABLE FirstTable(" + "id int Primary Key AUTO_INCREMENT," + "cca2 varchar(225)," + "ccn3 varchar(225)," + "cca3 varchar (225)," + "cioc varchar(225),"
					+ "status varchar(225)," 
					+ "region varchar(225)," + "subregion varchar(225)," 
					 + "fifa varchar(225)," 
	...
	public static void insert() throws Exception {
		...
		for (BasicClass RAC : useGson) {
			...
			try {
				...
				String sql = "insert into firsttable (cca2,ccn3,cca3,cioc,status,region,subregion,fifa,startOfWeek)"
						+ "values ('" +RAC.getCca2() + "','" + RAC.getCcn3() + "','" + RAC.getCca3()+ "','" + RAC.getCioc()+ "','" 
						+ RAC.getStatus() + "','" + RAC.getRegion() 
						+ "','" + RAC.getSubregion()
						+ "','" + RAC.getFifa()
								+ "','" + RAC.getStartOfWeek()+"')";
...
//ku
				 ...
				 Scanner scanner = new Scanner(System.in);
				      ...
				      String sql = "update firsttable set cioc='Sn' where id="+id;
